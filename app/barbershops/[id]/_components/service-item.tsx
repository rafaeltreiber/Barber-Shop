      ...
      <CardContent className="p-3">
        <div className="flex gap-4 items-center">
          <div className="relative min-h-[110px] min-w-[110px] max-h-[110px] max-w-[110px]">
            <Image className="rounded-lg" src={service.imageUrl} fill style={{
              objectFit: "contain"
            }} alt={service.name}
            />
          </div>
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <Sheet>
                ...
                <SheetContent className="p-0">
                  ...
                  {date && (
                    <div className="flex gap-3 py-6 overflow-x px-5 border-t border-solid border-secondary [&::-webkit-scrollbar]:hidden">
                      {timeList.map((time) => (
                  ...
                  <div className="py-6 p-5 boder-t border-solid border-secondary">
                    <Card>
